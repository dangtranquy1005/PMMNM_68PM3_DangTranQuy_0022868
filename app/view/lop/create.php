...
<div class="form-container">
    <div class="form-header">
        ...
        <p class="form-subtitle">Nhập thông tin chi tiết của lớp học dưới đây</p>
    </div>
    ...
    <form action="<?php echo BASE_URL; ?>/lop/store" method="POST">
        <div class="form-group">
            <label class="form-label" for="tenlop">Tên lớp học</label>
            <input type="text" id="tenlop" name="tenlop" class="form-control" placeholder="Ví dụ: 68PM3" required autocomplete="off">
        </div>

        <div class="form-group">
            <label class="form-label" for="mota">Mô tả / Ghi chú</label>
            <textarea id="mota" name="mota" class="form-control" placeholder="Ví dụ: Lớp Công nghệ phần mềm K68..." rows="4" style="resize: vertical; font-family: inherit;"></textarea>
        </div>
